        ...
        contents: [
          {
            ...
            parts: [
              {
                text: `reading the above conversation describe,the solution how to cure the mental health of the user, return the response in json analyzing the stress, peace, anxiety, depression of the user as i will be creating a table with the data, additonally generate a lengthy paragraph by analazying the data which will be in the json as well, make the json raw dont use triple backticks give it in string, important return the json data in string: \n\nUser: ${userMessage}\nBot: ${botMessage}`,
              },
            ],
          },
        ],
